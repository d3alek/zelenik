function initialize_plot(plot, plot_image, senses, desired_modes, reported_writes, displayables_config, span_click_event, plot_click_event, thing_name) {
    var key;
    var span;
    var value;
    var displayable;
    ...
    var actual_value;
    var auto;
    var hidden_or_nothing;
    var change_plot_positions_btn;
